...
/*	XOP Menu Compatibility
	...
	The routines were added in XOP Toolkit 6.40 but work with any version of Igor.

	The new routines are defined in this file. If you are updating an existing XOP that uses
	one of the old routines, you will need to change your XOP to use the new routines, listed below.
...
XOPActualMenuIDToMenuRef(int actualMenuID)
{
	...
	if (igorVersion >= 632) {
		XOPMenuRef menuRef = (XOPMenuRef)CallBack1(XOP_ACTUAL_MENUID_TO_MENUREF, (void*)actualMenuID);
		return menuRef;	
	}
...
XOPResourceMenuIDToMenuRef(int resourceMenuID)
{
	...
	return (XOPMenuRef)CallBack1(XOPMENUHANDLE, (void*)resourceMenuID);	
}
...
XOPGetMenuInfo(XOPMenuRef menuRef, int* actualMenuID, char* menuTitle, int* isVisible, void* reserved1, void* reserved2)
{
	...
	if (igorVersion >= 632) {
		int result = (int)CallBack6(XOP_GET_MENU_INFO, menuRef, (void*)actualMenuID, (void*)menuTitle, (void*)isVisible, reserved1, reserved2);
		return result;	
	}
...
XOPShowMainMenu(XOPMenuRef menuRef, int beforeMenuID)
{
	...
	if (igorVersion >= 632) {
		int err = (int)CallBack2(XOP_SHOW_MAIN_MENU, menuRef, (void*)beforeMenuID);
		return err;	
	}
...
XOPGetMenuItemInfo(XOPMenuRef menuRef, int itemNumber, int* enabled, int* checked, void* reserved1, void* reserved2)
{
	...
	if (igorVersion >= 632) {
		int err = (int)CallBack6(XOP_GET_MENU_ITEM_INFO, menuRef, (void*)itemNumber, (void*)enabled, (void*)checked, (void*)reserved1, (void*)reserved2);
		return err;	
	}
...
XOPGetMenuItemText(XOPMenuRef menuRef, int itemNumber, char text[256])
{
	*text = 0;
	...
	if (igorVersion >= 632) {
		int err = (int)CallBack3(XOP_GET_MENU_ITEM_TEXT, menuRef, (void*)itemNumber, text);
		return err;	
	}
...
XOPSetMenuItemText(XOPMenuRef menuRef, int itemNumber, const char* text)
{
	...
	if (igorVersion >= 632) {
		int err = (int)CallBack3(XOP_SET_MENU_ITEM_TEXT, menuRef, (void*)itemNumber, (void*)text);
		return err;	
	}
...
XOPInsertMenuItem(XOPMenuRef menuRef, int afterItemNumber, const char* text)
{
	...
	if (igorVersion >= 632) {
		int err = (int)CallBack3(XOP_INSERT_MENU_ITEM, menuRef, (void*)afterItemNumber, (void*)text);
		return err;	
	}
...
XOPDeleteMenuItem(XOPMenuRef menuRef, int itemNumber)
{
	...
	if (igorVersion >= 632) {
		int err = (int)CallBack2(XOP_DELETE_MENU_ITEM, menuRef, (void*)itemNumber);
		return err;	
	}
...
XOPDeleteMenuItemRange(XOPMenuRef menuRef, int firstMenuItemNumber, int lastMenuItemNumber)
{
	...
	if (igorVersion >= 632) {
		int err = (int)CallBack3(XOP_DELETE_MENU_ITEM_RANGE, menuRef, (void*)firstMenuItemNumber, (void*)lastMenuItemNumber);
		return err;	
	}
	...
	// Here if Igor is 6.31 or before
	{
			...
			totalNumItemsInMenu = XOPCountMenuItems((MenuHandle)menuRef);
...
XOPEnableMenuItem(XOPMenuRef menuRef, int itemNumber)
{
	...
	if (igorVersion >= 632) {
		int err = (int)CallBack2(XOP_ENABLE_MENU_ITEM, menuRef, (void*)itemNumber);
		return err;	
	}
...
XOPDisableMenuItem(XOPMenuRef menuRef, int itemNumber)
{
	...
	if (igorVersion >= 632) {
		int err = (int)CallBack2(XOP_DISABLE_MENU_ITEM, menuRef, (void*)itemNumber);
		return err;	
	}
...
XOPCheckMenuItem(XOPMenuRef menuRef, int itemNumber, int state)
{
	...
	if (igorVersion >= 632) {
		int err = (int)CallBack3(XOP_CHECK_MENU_ITEM, menuRef, (void*)itemNumber, (void*)state);
		return err;	
	}
...
XOPFillMenu(XOPMenuRef menuRef, int afterItemNumber, const char *itemList)
{
	...
	if (igorVersion >= 632) {
		int err = (int)CallBack3(XOP_FILL_MENU, menuRef, (void*)afterItemNumber, (void*)itemList);
		return err;	
	}
...
XOPFillMenuNoMeta(XOPMenuRef menuRef, int afterItemNumber, const char *itemList)
{
	...
	if (igorVersion >= 632) {
		int err = (int)CallBack3(XOP_FILL_MENU_NO_META, menuRef, (void*)afterItemNumber, (void*)itemList);
		return err;	
	}
